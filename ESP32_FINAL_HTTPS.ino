...
const char* serverUrl = "https://192.168.1.53:8000";
...
void fetchFromServer(const String& endpoint, const String& prefix) {
  ...
  client.setInsecure();  // Acepta tu certificado self‑signed
  ...
  if (code == HTTP_CODE_OK) {
    ...
    payload.trim();payload.replace("\"",""); payload.replace("\r",""); payload.replace("\n","");
    Serial.print("[HTTPS] Payload: "); Serial.println(payload);
